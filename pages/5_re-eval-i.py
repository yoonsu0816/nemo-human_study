...
st.set_page_config(page_title="Re-evaluation: Study I", page_icon=":pencil2:", layout="wide", initial_sidebar_state="collapsed")

# Prolific ID input at the top
st.title(":pencil2: Re-evaluation: Study I")
...
# Only load imagenet-r samples with target ID
dataset_model = "imagenet-r_vit"
dataset = "imagenet-r"
target_model = "vit"
...
def save_current_sample():
    ...
    document = {
        ...
        "re_evaluation_type": "imagenet-r_2336"
    }
    ...
    if test_mode:
        ...
        try:
            ...
            results_file = os.path.join(results_dir, f"{participant_id}_re_eval_imagenet-r_2336.json")
